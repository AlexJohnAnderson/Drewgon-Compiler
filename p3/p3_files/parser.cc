...
#line 224 "drewgon.yy"
			...
			// translation to create an AST
				...
				DeclNode * declNode = (yystack_[0].value.transFnDeclNode);
...
#line 263 "drewgon.yy"
				...
				(yylhs.value.transFnType) = new FnTypeNode(p,list,(yystack_[0].value.transType)); 
			}
#line 689 "parser.cc"
    break;
...
#line 275 "drewgon.yy"
                        {
			  (yystack_[2].value.transTypeList)->push_back((yystack_[0].value.transType));
...
#line 281 "drewgon.yy"
				...
				(yylhs.value.transFnDeclNode) = new FnDeclNode(p, (yystack_[6].value.transType), (yystack_[5].value.transID), list, (yystack_[1].value.transStmtList)); 
			}
#line 717 "parser.cc"
    break;
...
#line 287 "drewgon.yy"
				...
				(yylhs.value.transFnDeclNode) = new FnDeclNode(p, (yystack_[7].value.transType), (yystack_[6].value.transID), (yystack_[4].value.transFormalDeclList), (yystack_[1].value.transStmtList)); 
			}
#line 726 "parser.cc"
    break;
...
#line 293 "drewgon.yy"
                        { 
			  std::list<FormalDeclNode *> * list = new std::list<FormalDeclNode *>();
              list->push_back((yystack_[0].value.transFormalDecl));
              (yylhs.value.transFormalDeclList) = list;
			  }
#line 736 "parser.cc"
    break;
...
#line 299 "drewgon.yy"
                        { 
			  (yystack_[2].value.transFormalDeclList)->push_back((yystack_[0].value.transFormalDecl));
...
#line 305 "drewgon.yy"
                        { 
			  const Position * p = new Position((yystack_[1].value.transType)->pos(), (yystack_[0].value.transID)->pos());
			  (yylhs.value.transFormalDecl) = new FormalDeclNode(p, (yystack_[1].value.transType), (yystack_[0].value.transID));
			}
#line 754 "parser.cc"
    break;
...
#line 333 "drewgon.yy"
				...
				(yylhs.value.transStmt) = new ForStmtNode(p, (yystack_[8].value.transStmt), (yystack_[6].value.transExp), (yystack_[4].value.transStmt), (yystack_[1].value.transStmtList)); 
			}
#line 799 "parser.cc"
    break;
...
#line 353 "drewgon.yy"
                        { 
				Position * p = new Position((yystack_[0].value.transAssignExp)->pos(), (yystack_[0].value.transAssignExp)->pos());
				(yylhs.value.transStmt) = new AssignStmtNode(p, (yystack_[0].value.transAssignExp));
			}
#line 834 "parser.cc"
    break;
...
#line 358 "drewgon.yy"
                        {
				Position * p = new Position((yystack_[1].value.transID)->pos(), (yystack_[0].value.transToken)->pos());
...
#line 383 "drewgon.yy"
                        { 
 				Position * p = new Position((yystack_[0].value.transToken)->pos(), (yystack_[0].value.transToken)->pos());
...
#line 388 "drewgon.yy"
                        { 
				Position * p = new Position((yystack_[0].value.transCallExp)->pos(), (yystack_[0].value.transCallExp)->pos());
				(yylhs.value.transStmt) = new CallStmtNode(p, (yystack_[0].value.transCallExp));
				//$$ = $1;
			}
#line 898 "parser.cc"
    break;
...
#line 464 "drewgon.yy"
                        { 
				Position * p = new Position((yystack_[1].value.transToken)->pos(), (yystack_[1].value.transToken)->pos());
...
#line 474 "drewgon.yy"
                        { 	
				Position * p = new Position((yystack_[2].value.transID)->pos(), (yystack_[0].value.transExp)->pos());
...
#line 480 "drewgon.yy"
				...
				(yylhs.value.transCallExp) = new CallExpNode(p, (yystack_[2].value.transID), list); 
			}
#line 1059 "parser.cc"
    break;
...
#line 486 "drewgon.yy"
				...
				(yylhs.value.transCallExp) = new CallExpNode(p, (yystack_[3].value.transID), (yystack_[1].value.transExpList));
			}
#line 1068 "parser.cc"
    break;
...
#line 492 "drewgon.yy"
                        { 
				ExpNode* expnode = (yystack_[0].value.transExp);
				(yylhs.value.transExpList)->push_back(expnode);
			}
#line 1077 "parser.cc"
    break;
...
#line 507 "drewgon.yy"
              ...
              Position * p = new Position((yystack_[0].value.transIntToken)->pos(), (yystack_[0].value.transIntToken)->pos());
              (yylhs.value.transExp) = new IntLitNode(p, (yystack_[0].value.transIntToken)->num());
...
#line 514 "drewgon.yy"
                        { 
				Position * p = new Position((yystack_[0].value.transStrToken)->pos(), (yystack_[0].value.transStrToken)->pos());
				(yylhs.value.transExp) = new StrLitNode(p, (yystack_[0].value.transStrToken)->str());
			}
#line 1114 "parser.cc"
    break;
...
#undef YYCASE_
  ...
  Parser::yyrline_[] =
  {
       0,   212,   212,   218,   223,   234,   238,   244,   246,   250,
     252,   254,   257,   262,   269,   274,   280,   286,   292,   298,
     304,   311,   314,   319,   327,   332,   337,   342,   348,   352,
     357,   362,   367,   372,   377,   382,   387,   394,   398,   403,
     408,   413,   418,   423,   428,   433,   438,   443,   448,   453,
     458,   463,   468,   473,   479,   485,   491,   496,   502,   506,
     513,   518,   522,   526,   530,   534,   539
  };
